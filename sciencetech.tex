...
\begin{cdrfigure} [Momentum distributions]{fig::particlemomenta}{Left: Momentum distributions of particles produced by the neutrinos from the neutrino beam in DUNE. } 
...
\begin{table}[]
\centering
\caption{DUNE goals are for the total normalizaUon uncertainty on the ?e appearance sample. The DUNE analysis will be a 3-flavor oscillaUon fit such that uncertainUes correlated among the four FD samples will largely cancel \cite{cdr}.}
\label{DUNEsen}
\begin{tabular}{lllll}
