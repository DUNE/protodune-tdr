...
The production processing will likely have \fixme{typically has?} more than one processing step,
thus \fixme{creating derived data and} multiplying the data volume.  The volume of the derived data is assumed to be smaller than that for the raw data.
