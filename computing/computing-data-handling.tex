...
\fixme{spell out NERSC acronym for first time use}
...
\fixme{This may trigger the question whether we can harvest such pre-existing resources at other institutions. Do we know what exists and is available ? Do we have a plan or are we ignoring this for now ?}
