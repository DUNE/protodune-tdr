...
\begin{cdrtable}[Raw data storage parameter estimates]{lr}{goldi}{Estimates of nominal raw data parameters driving the design for the raw data storage and management.}   
