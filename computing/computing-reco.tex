...
\begin{cdrfigure}[Primary beam particle direction resolution for protons 2GeV/c, as a function of true trajectory orientation in ZX plane, ZY plane and as a function of the track length (trajectories reconstructed using Line Cluster and PMA).]{PMAdirection}{Some text.}
\includegraphics[width=0.3\textwidth]{figures/dFi-vs-beamXZ_primary_ptoton.gif}
\includegraphics[width=0.3\textwidth]{figures/dFi-vs-beamYZ_primary_proton.gif}
\includegraphics[width=0.3\textwidth]{figures/dFi-vs-TrkLen_primary_proton.gif}
\end{cdrfigure}

\begin{cdrfigure}[Example of reconstructed event of simulated proton with initial momentum 2 GeV/c]{PMAproton2gevc}{Example of reconstructed event of simulated proton with initial momentum 2 GeV/c (reconstruction algorithms: gaushit, linecluster and PMA).}
...
\end{cdrfigure}
\begin{cdrfigure}[Example of reconstructed cosmic muons in protoDUNE]{PMAcosmics}{Example of reconstructed cosmic muons using gaushit, linecluster and PMA.}
