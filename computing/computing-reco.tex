...
\begin{cdrfigure}[Example of reconstructed event of simulated proton with initial momentum 2 GeV/c]{PMAproton2gevc}{Example of reconstructed event of simulated proton with initial momentum 2 GeV/c.}
\includegraphics[width=0.45\textwidth]{figures/evd.twq-proj.1.17703.png}
\includegraphics[width=0.45\textwidth]{figures/evd.larortho3d.1.17703.png}
\end{cdrfigure}
\begin{cdrfigure}[Example of reconstructed cosmic muons in protoDUNE]{PMAcosmics}{Example of reconstructed cosmic muons with PMA.}
\includegraphics[width=0.45\textwidth]{figures/evd.larortho3d.1.1302.png}
\end{cdrfigure}
