...
of individual particle trajectories (trajectory fits)~\cite{pma_algorithm} %\cite{icarus3dreco}. 
%\fixme{missing citation icarus3dreco, so Anne changed it to pma_algorithm}
Instead of
...
\fixme{cannot be associated because it's impossible, or are not allowed to be associated and the 3D imaging process accomplishes this? Please clarify}
(The definition
