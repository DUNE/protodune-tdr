...
\begin{cdrfigure}[The reconstructed invariant masses of $\pi^0$ candidates in
  Monte Carlo]{pizeromass}{The reconstructed invariant masses of $\pi^0$ candidates in
...
\includegraphics[width=0.3\textwidth]{mu_eff_pandora.pdf}
\includegraphics[width=0.3\textwidth]{trk_completeness_pandora.pdf}
\includegraphics[width=0.3\textwidth]{mu_res_pandora.pdf}
\end{cdrfigure}
...
muon momentum, the middle figure shows the distribution of tracking completeness, and the right-hand figure shows the
distribution of the difference between the reconstructed muon track length and the true track length.}
\includegraphics[width=0.3\textwidth]{mu_eff_pmtrack.pdf}\includegraphics[width=0.3\textwidth]{trk_completeness_pmtrack.pdf}\includegraphics[width=0.3\textwidth]{mu_res_pmtrack.pdf}
\end{cdrfigure}
