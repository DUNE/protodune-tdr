...
the design specification of the cold electronics. %(Fig.~\ref{fig:rms3} in Sec.~\ref{sec:tpc-signal-calibration}).   
...
\fixme{there was no existing citation in bib file, so I picked one from inspirehep; please check}
also works by
...
\fixme{needs citation in bib file}
