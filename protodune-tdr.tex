...
\section{Introduction {\color{red} (Flavio,Christos)}}
\input{introduction}

\section{Scientific and technical motivations {\color{red} (Thomas)}}
\input{sciencetech}

\section{ProtoDUNE detector overview {\color{red} (Flavio,Christos,Thomas)}}
\input{det-overview}

\section{Detector components {\color{red} (Tim, Jim)}}
\input{det-comp}

\section{ProtoDUNE computing and software {\color{red} (Tom, Amir)}}
\input{computing}
