...
\nomenclature{QA/QC}{quality assurance/quality control}
\nomenclature{QE}{quantum efficiency}
...
\nomenclature{CASTOR}{Cern Advanced STORage system, a hierarchical storage management system developed at CERN}
...
\nomenclature{DCS}{detector control system}
\nomenclature{DSS}{detector support system}
\nomenclature{DRAM}{dynamic random access memory}
\nomenclature{EHN1}{extension to hall in North Area at CERN in which both ProtoDUNEs reside}
\nomenclature{ENC}{electronic noise charge}
\nomenclature{FEMB}{front-end mother board}
\nomenclature{FE}{front-end (electronics)}
\nomenclature{FR4}{a composite material composed of woven fiberglass cloth with an epoxy resin binder that is flame resistant (Wikipedia)}
\fixme{FR4 definition ok?}
...
\nomenclature{GTT}{engineering company in containment systems for the shipping and storage in cryogenic conditions of LNG (liquefied natural gas)}
\nomenclature{H4}{H4 beamline, the beamline extension to ProtoDUNE-SP}
...
\nomenclature{NP04}{the CERN experiment designation for ProtoDUNE-SP}
...
\nomenclature{TPB}{tetraphenyl-butadiene}
