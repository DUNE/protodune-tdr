...
The maximum electron drift time in the TPC is about 2.2 ms. In order
to keep the  pile-up in the TPC at the level of percent, the planned
beam rate should be at the level of
100 Hz.  The ProtoDUNE-SP TPC has two drift volumes separated by a
