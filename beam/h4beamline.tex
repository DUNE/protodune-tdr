...
\fixme{What does "this particular configuration" refer to ? the one shown in the figure ? or the one chosen ? why is it focused at the cryostat entrance ?}
...
\end{cdrfigure}
\fixme{beam line elements should be briefly enumerated in caption so that the reader knows what is shown, e.g. O17-22 represents ...,C12 is ... etc }
...
\fixme{added dimension and material, OK ?}
...
\begin{cdrtable}[Beam composition]{cccccc}{beampartcomp}{Beam composition (in percentage)  at the cryostat entrance for particles contained in the beam pipe (R= XX cm).}
...
\begin{cdrfigure}[Muon halo intensity at the cryostat face]{muonhalo_HE}{Muon halo intensity at the cryostat face for muons originating fro the H4 beam line and with $P_\mu  \ge 4$~Gev/c. The origin of the coordinate system is centered on the cryostat and dimensions are in mm. Color scale is in units of $\mu /m^2/spill$.}
\includegraphics[width=0.55\textwidth]{muon_map_HE_square.pdf}
\end{cdrfigure}
