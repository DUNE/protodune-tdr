...
Preliminary results using full simulation indicate that a momentum resolution on the order of  2\% is achievable. The same devices which are used for beam monitoring can also be used for momentum measurement.
%
