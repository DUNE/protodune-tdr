...
\fixme{Is $X_0$ defined?} The tree devices needed for momentum measurement will consist of one layer only, oriented perpendicularly to the magnet deflection.
...
readout, measuring approximately 128 mm $\times$128 mm, readily available that can also be used as beam profile monitors.   %%% to here  Anne 10/14 %%%
