...
insert detector overview + requirements here \fixme{The whole chapter is `overview'; insert detector requirements here! Link added.}
...
%%%--- insert section on calibration strategy ---%%%%%
\input{calibration_strategy}
...
\fixme{ minimize reference to laser system}
...
%%\subsection{PDS Light Extraction}

%%%% insert detector parameter calibration studies/measurements %%%
\input{detector_calib}
