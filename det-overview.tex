...
\begin{figure}[htb]
\centering
\includegraphics[width=0.8\textwidth]{figures/Signal_Extraction.png}
...
\caption{The simulated electronics response function in the time 
...
\caption{Impact of the space charge effect on reconstructed tracks in the detector.  The impact on a reconstructed track can be broken up into two distinct features:  a squeezing of the sides of the tracks in the transverse TPC directions that can somewhat resemble a rotation (``A'') and a bowing of the track toward the cathode that is most pronounced in the middle of the TPC (``B'').} \label{fig:SCEtrackEffects}
\end{figure}
