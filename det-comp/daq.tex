...
\fixme{KH:The photon people like consider the SSPs as electronics, not DAQ, so that may all be in the photon section}
\fixme{TK:need final agreement on this issue}
\fixme{KH: OK for description of SSPs in PDS section, but rates are missing.}
