...
\fixme{from docdb 1504 sec 6.3 I can't tell if there's ONE ground plane at the TOP, ONE at the BOTTOM or two. Sometimes singular, sometimes plural. Needs clarification.}
...
If a discharge occurrs on one field cage, the %nearby 
...
The resistors along the divider provide a linear DC voltage gradient. However, at shorter time scale ($\ll$1~s), the electrical behavior of the divider is determined by the various capacitances on and between each electrode, and %.  This divider
