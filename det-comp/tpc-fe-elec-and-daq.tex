...
a feedthrough, with one feedthrough servicing one APA.
...
\includegraphics[width=2.75]{tpcce_signal_FT_1.jpg}
...
\includegraphics[width=1.0\linewidth]{tpcce_ceflange_sbnd.png}
\end{cdrfigure}
...
\includegraphics[width=1.0\linewidth]{tpcce_wib_timing.jpg}
\end{cdrfigure}
...
WIBs, shown in Figures~\ref{fig:tpcce_ceflange_sbnd} and~\ref{fig:argh}.
...
\includegraphics[width=1.0\linewidth]{tpcce_dune_wib.jpg}
\end{cdrfigure}
