...
\fixme{reduce this section to about 1 page (Flavio)}
...
\includegraphics[width=0.3\linewidth]{operating_principle}
\end{cdrfigure}
%***********************************************************************%
...
\includegraphics[width=0.3\linewidth]{APA_ARAPUCA}
\end{cdrfigure}
%***********************************************************************%
...
\includegraphics[angle=0,width=0.6\textwidth]{calPD_Calibration_diffuser_system_protoDUNE_slide_left_half.pdf}
\includegraphics[angle=0,width=0.4\textwidth]{calPD_Calib_diffuser_locations_protoDUNE.pdf}
\end{cdrfigure}

%\fixme{left hand figure's text is way too small} Made figure bigger and right fig smaller.  We'll see. LMM
%
%
...
%
\begin{cdrfigure}[UV-light monitoring illumination calculation]{fig-c-4}{Simulated light distributions of at the APA location for the cases of the VUV light emitted by either the central diffuser only (left figure), or by outer four diffusers simultaneously (right figure).
...
%
 \begin{cdrfigure}[Detected UV-light monitoring system light pulses]{fig-wf}{Photon detector light pulses detected by readout electronics. Recorded waveforms have range from few photo-electrons (left figure), to tens of photo-electrons (middle figure), to hundreds of photo-electrons (right figure).}
