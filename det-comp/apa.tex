...
\includegraphics[width=0.7\textwidth]{figures/tpc_apa_supportcombmodel} 
\end{cdrfigure}
...
modular CE boxes.}
\includegraphics[width=0.9\textwidth]{figures/tpc_apa_electronicsmountingdiagram} 
\end{cdrfigure}
...
\includegraphics[width=0.9\textwidth]{figures/tpc_apa_pinslotdrawing} 
\end{cdrfigure}
