...
\begin{itemize}
\item 18 CPA modules, each with a frame and resistive cathode panel %, field-shaping strips, metallic buttons, pin-and-slot connections
