...
\begin{cdrfigure}[CPA hinge1]{cpa-hinge1}{The top field cage modules are hung vertically with the CPAs when moved into the cryostat, then rotated to horizontal to attach to the APA} 
...
The CPA frame has been evaluated using empirical and FEA calculations.  Detailed calculations are shown in ??? 
...
{\bf Lifting the CPA During Installation}
...
\begin{cdrfigure}[CPA H load]{cpa-h_load}{Stress and deflection of a connected 3 CPA stack in horizontal position supported at both ends} 
\includegraphics[width=\linewidth]{tpc_cpa_h_load.png}
\end{cdrfigure}


{\bf CPA Hanging with all FC Attached in Installation Position}
...
\begin{cdrfigure}[CPA hinge1]{cpa-load1}{Stress and deflection of a connected 3 CPA stack suspended on the rail with 4 FC modules} 
\includegraphics[width=\linewidth]{tpc_cpa_fc_load1.png}
\end{cdrfigure}


{\bf CPA Hanging with all FC Attached in Deployed Position With Weight of Workers on FC}
...
\begin{cdrfigure}[CPA hinge1]{cpa-load2}{Stresses and Deflections of CPA with FC Deployed and 200 lb Worker Load} 
\includegraphics[width=\linewidth]{tpc_cpa_fc_load2.png}
\end{cdrfigure}

{\bf Connection Stresses}
...
{\bf Deformation and Stress Due to Pressure from Circulating Liquid Argon}
