...
The fundamental idea at the basis of the ARAPUCA is to trap photons inside a box with highly reflective internal surfaces, so that the detection efficiency of trapped photons is high even with a  limited active coverage of its internal surface \cite{Machado:2016jqe}.
...
Two arrays of small ARAPUCAs are installed in the detector %inside protoDUNE 
...
A UV-light-based monitoring system that serves to monitor the relative performance and time resolution of the system has been designed. % and is described here.
