...
\begin{cdrfigure}[Photon detection system overview]{PD_overview}{Overview of the PDS
   ...
   is inserted into an APA frame. Ten photon detectors (PDs) are inserted
    into an APA frame.}
\includegraphics[width=1.0\linewidth]{pd_schem}
\end{cdrfigure}
...
\includegraphics[width=0.5\linewidth]{PD_radiator_mount}
\end{cdrfigure}
...
\includegraphics[width=0.456\linewidth]{PD_mounting_inslide}
\includegraphics[width=0.444\linewidth]{PD_endblock_mnt}
\end{cdrfigure}
...
\includegraphics[width=0.50\linewidth]{pd_flat_installtest-half}
\end{cdrfigure}
...
\includegraphics[width=0.55\linewidth]{PD_SiPMMountPCB_front}
\includegraphics[width=0.4\linewidth]{PD_SiPMMountPCB_back}
\end{cdrfigure}
...
\includegraphics[width=0.50\linewidth]{PD_cable_intube}
\end{cdrfigure}
...
\includegraphics[angle=0,width=0.7\textwidth]{calPD_concept-from-35ton}
\end{cdrfigure}
%
