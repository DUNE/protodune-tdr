...
%\fixme{Is this ``Relative'' light yield? Yes it is, absolute is light/energy  }
...
were chosen for ProtoDUNE-SP. \cite{TallBo4} % \fixme{Make Ref (DUNE DocDB 138, JINST 11 C05019)}
