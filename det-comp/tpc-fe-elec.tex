...
to the APA frame. These connections are made through the CE enclosure described in 
Section~\ref{blahblah} and its mounting brackets. All power-return leads and all cable shields 
involving the CE modules are connected to the Common plane of the FEMB, as well as to the CE flange.
...
and an electron diverter, as shown in Figure~\ref{tpcce_cr_board}. The voltages are supplied 
through eight SHV connectors mounted on 
the CE flange. RG-316 coaxial cables carry the voltages to a patch panel 
...
into the APA wire-board stacks, as described in Section~\ref{apa_wire_wrap}. The CR boards 
...
in Figure~\ref{tpcce_cr_board}. Additionally there are 48 
...
\includegraphics[width=0.4\linewidth]{tpcce_cr_board.pdf}
\end{cdrfigure}
...
to the APA frame through the CE Faraday box described in Section~\ref{blahblah}. The amplifiers 
have input impedance of 50 Ohms with 22-nF coupling capacitors, as shown in Figure~\ref{tpcce_cr_board}. 
