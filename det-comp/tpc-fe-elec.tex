...
8 of the 16 wire will be power feeds, as described in Figure~\ref{fig:tpcce_lv_req}. The other 8 wires
will be attached to the common of the FEMB, as described in Section~\ref{subsec:ele_design}. For
