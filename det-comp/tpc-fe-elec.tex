...
mounted directly on the APA, %, as shown in Figure~\ref{fig:tpcce_FEMBonAPA}, 
...
%removed per Bo \begin{cdrfigure}[Front-end (FE) electronics mounted on an APA]{tpcce_FEMBonAPA}{The 
%...
...
\includegraphics[width=0.4\linewidth]{tpcce_apa_flange}
\end{cdrfigure}
...
\includegraphics[width=0.9\linewidth]{tpc_wire_bias_scheme_20170317}
\end{cdrfigure}
...
\includegraphics[width=0.9\linewidth]{tpcce_schem}
\end{cdrfigure}
...
\includegraphics[width=0.65\linewidth]{tpcce_CMBpix_1}
\includegraphics[width=0.65\linewidth]{tpcce_CMBpix_2}
\includegraphics[width=0.45\linewidth]{tpcce_CMBpix_3}
\end{cdrfigure}
...
\begin{cdrfigure}[Layout of the 16-channel FE ASIC]{tpcce_FE_ASIC}{The layout of the 16-channel FE ASIC}
\includegraphics[width=\linewidth]{tpcce_FE_ASIC_pinout}
\end{cdrfigure}
...
\includegraphics[width=\linewidth]{tpcce_shaper_out}
\end{cdrfigure}
...
\includegraphics[width=\linewidth]{tpcce_ADC_ASIC_pinout} % New one
\end{cdrfigure}
...
LN2 = liquid nitrogen}
\includegraphics[width=0.45\linewidth]{tpcce_enc_14mV}
\includegraphics[width=0.45\linewidth]{tpcce_enc_25mV}
\end{cdrfigure}
...
\includegraphics[width=3in]{tpcce_box_1}
\includegraphics[width=3in]{tpcce_box_2}
\end{cdrfigure}
...
\begin{cdrfigure}[CE feedthrough configuration and internal cable routing]{tpcce_FT_InternalCableRoute}{
...
\includegraphics[width=7in]{tpcce_FT_InternalCableRoute}
\end{cdrfigure}


\begin{cdrfigure}[Conceptual design of TPC CE feedthrough]{tpcce_signal_FT}{
...
\includegraphics[width=0.6\linewidth]{tpcce_signal_FT}
\end{cdrfigure}
...
\includegraphics[width=0.9\linewidth]{tpcce_cable_routing}
\end{cdrfigure}
...
\includegraphics[width=0.9\linewidth]{tpcce_samtec_results}
\end{cdrfigure}
...
\begin{cdrfigure}[Exploded view of the signal flange]{tpcce_ceflange_dune}{Exploded view of the ProtoDUNE-SP signal flange.}
\includegraphics[width=0.9\linewidth]{tpcce_ceflange_dune}
\end{cdrfigure}
...
\begin{cdrfigure}[Power and Timing Card (PTC) and timing distribution]{tpcce_wib_timing}{Power and Timing Card (PTC) 
and timing distribution to the WIB and FEMBs.}
\includegraphics[width=0.5\linewidth]{tpcce_wib_timing}
\end{cdrfigure}
...
\begin{cdrfigure}[LV power distribution to the Warm Interface Boards and FEMBs]{tpcce_wib_power}{LV power distribution 
...
\includegraphics[width=0.6\linewidth]{tpcce_wib_power} %REPLACE THIS IMAGE
\end{cdrfigure}
...
\includegraphics[width=0.9\linewidth]{tpcce_dune_wib}
\end{cdrfigure}
...
\includegraphics[width=0.7\linewidth]{tpcce_power_connector} % REPLACE THIS IMAGE
\end{cdrfigure}
