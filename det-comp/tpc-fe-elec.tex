...
\includegraphics[width=0.7\linewidth]{tpcce_mpod_top.png}
\end{cdrfigure}
...
combined fuse value. The bottom of the fuse PCB is shown in Figure~\ref{tpcce_fused_cable}.
...
in Section~\ref{subsubsec:pouer_timing_card}. The PTC will have two normal DSUB37 connectors to
