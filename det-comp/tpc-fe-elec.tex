...
\fixme{Outdated text in the following pp? - Matt}
...
distributed along the cryostat roof (Fig.~\ref{fig:tpcce_FT_InternalCableRoute}).
...
\includegraphics[width=3in]{tpcce_samtec_lv.pdf}
\end{cdrfigure}
...
The same MPOD will supply the wire bias voltage to 8 SHV connectors at the CE flange.
...
RG-316 coaxial cables will connect the wire bias voltages from the MPOD to the standard SHV
