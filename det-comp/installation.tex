...
\begin{cdrfigure}[The APA with the special tooling attached]{APA-tooling}{The APA with the special tooling attached.  The right image shows the orientation of the APA as delivered, the left shows the orientation when it is lowered into the material SAS. }
