...
\begin{cdrfigure}[The APA with custom lifing tooling attached.]{APA-tooling}{The APA with the special tooling attached.  The right image shows the orientation of the APA as delivered, the left shows the orientation when it is lowered into the material SAS. }
...
\begin{cdrfigure}[other FC image]{FC-assy-2}{other FC image}
%\includegraphics[width=1.00\linewidth]{}
\end{cdrfigure}
