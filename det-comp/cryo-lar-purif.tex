...
\end{cdrfigure}
\fixme{Waiting for orig diagram for process flow from DM}
...
%\includegraphics[width=\linewidth]{???}
\end{cdrfigure}
\fixme{Waiting for orig diagram for 3D view of the installation from DM; May be replaced with a more complete one with building also}
...
%\includegraphics[width=\linewidth]{???}
\end{cdrfigure}
\fixme{Waiting for orig diagram for int-cryogenics-detail from DM}
...
%\includegraphics[width=\linewidth]{???}
\end{cdrfigure}
\fixme{Waiting for orig diagram for 2D simulation of the purge in open loop process  from DM; May be replaced with a more complete one with building also}
