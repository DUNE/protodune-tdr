...
The cryostat will hold an inventory of 760 ton of liquid argon. The standard grade specification for argon is a minimum purity of 99.995\%, allowing a maximum concentration of 5.0 ppm for O2 and 10.5 ppm for H2O.  Typically the impurity levels in the delivered argon are are much lower, in fact sufficiently low to meet the physics requirements, and it is too costly to purchase argon with tighter specifications.
