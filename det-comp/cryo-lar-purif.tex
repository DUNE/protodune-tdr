...
%
The \textit{External Cryogenics} includes the systems used for the storage and eventual production of the cryogens needed for the operation of the cryogenic system (LN2 for cooling, LAr for the cryostat) and GAr generated from the cryogenic storage tanks. In particular, it encompasses:
%
\begin{itemize}
\item The receiving facilities for LAr and liquid ntrogen (LN2) tanker trucks;
...
\item The regeneration system for the LAr purification (with GAr and GAr/H2 cylinders).
\end{itemize}
%
...
\includegraphics[width=0.8\linewidth]{cryo-process-flow}
\end{cdrfigure}
...
\fixme{This implies that N2 is at the level of 30-35 ppm - way too bad for the Scintillation Light .. practically unacceptable, as it would imply a loss of ~70\% of the light due to N2 quenching.}
...
Vessel ullage maximum operating pressure & 0.120 MPa (230 mBarg)\\ \colhline
