...
oriented at different angles with respect to those on the other planes to enable 3D reconstruction.  The wire pitches for %all wire planes is 4.5~mm, and each APA holds a total of 2,560 wires. 
...
\begin{cdrfigure}[Major components of the ProtoDUNE-SP TPC]{protodune-sp-tpc}{The major components of the ProtoDUNE-SP TPC. }
\includegraphics[width=0.9\textwidth]{protodune-sp-tpc.jpg}
\end{cdrfigure}
